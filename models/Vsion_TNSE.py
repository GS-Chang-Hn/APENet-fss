...
class FewShotSeg(nn.Module):
    ...
    def forward(self, supp_imgs, fore_mask, back_mask, qry_imgs):
        ...
        global supp_fg_fts_all
        global supp_fg_prototypes_all
        ...
        for epi in range(batch_size):
            ...
            """
            supp_fg_fts_all = supp_fg_fts
            supp_fg_prototypes_all = fg_prototypes
        ...
        return que_output_foreground, que_output_background, sup_output_foreground, sup_output_background, supp_fg_fts_all, supp_fg_prototypes_all  # [1 2 448 448] [shot 2 448 448]
